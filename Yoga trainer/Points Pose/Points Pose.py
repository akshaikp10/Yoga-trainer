...
def gen():
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while cap.isOpened():
            ...
            cv2.putText(image, 'Points Pose ', (10, 120),
            cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0) if check_body_straight_5 and check_arm_90_5 and check_leg_straight_5  else (0, 0, 255), 2)
