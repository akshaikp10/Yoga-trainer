...
def gen():
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while cap.isOpened():
            ...
            cv2.putText(image, 'Cobra Pose', (10, 120),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0) if check_arm_angle_7 and check_hip_angle_7 and check_leg_straight_7 else (0, 0, 255), 2)
            # Render timer status
            if timer_running:
