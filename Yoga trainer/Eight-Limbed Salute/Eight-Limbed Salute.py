...
def gen():
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while cap.isOpened():
            ...
            cv2.putText(image, 'Eight-Limbed Salute', (10, 120),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0) if check_body_straight_6 and check_hip_angle_6 and check_arm_angle_6 else (0, 0, 255), 2)
            # Render timer status
            if timer_running:
