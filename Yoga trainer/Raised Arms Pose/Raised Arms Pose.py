...
def gen():
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while cap.isOpened():
            ...
            # text on image
            cv2.putText(image, 'Arms straight 1: {}'.format(arms_parallel_2), (10, 30), 
                        cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0) if arms_parallel_2 else (0, 0, 255), 2)
            
            
            cv2.putText(image, 'Arms straight 2: {}'.format(angles_90_2), (10, 60), 
            ...
            cv2.putText(image, 'Raised Arms Pose', (10, 120),
                       cv2.FONT_HERSHEY_SIMPLEX, 0.7,
                        (0, 255, 0) if arms_parallel_2 and angles_90_2 and check_body_lower_2 else (0, 0, 255), 2)
